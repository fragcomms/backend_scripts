...
def main(input_mka, map_name="Nuke"):
    ...
    all_tracks_data = llm_engine.correct_transcriptions(all_tracks_data, map_name, hotwords, GENERAL_CS2_TERMS)
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("Usage: python transcriber-para.py <path_to_audio.mka> [map_name]", file=sys.stderr)
        sys.exit(1)
