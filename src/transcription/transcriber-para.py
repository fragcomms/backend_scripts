...
def main(input_mka, map_name="Nuke"):
    ...
    print(f"[DEBUG] Tracks with transcription data: {list(all_tracks_data.keys())}", flush=True)
    # ------------------
        ...
        if track_title in all_tracks_data:
            ...
            try:
                ...
                if os.path.exists(output_json):
                    ...
                    print(f"[DEBUG] ERROR: Python wrote the file, but OS says it doesn't exist at '{output_json}'", flush=True)
            ...
            print(f"[DEBUG] SKIPPING track '{track_title}': No transcription data found for this track.", flush=True)
