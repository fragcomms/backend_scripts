...
class ASREngine:
    ...
    def _configure_decoding(self, extended_hotwords):
        ...
        with open_dict(decoding_cfg):
            ...
            decoding_cfg.malsd_batch.boosting_tree.context_score = 5.0 # 5x weight for CS2 phrases
    ...
    def prep_audio_track(self, input_mka, track_idx):
        ...
        speech_timestamps = get_speech_timestamps(
            wav_tensor, vad, sampling_rate=16000, threshold=0.5,
            speech_pad_ms=400, min_silence_duration_ms=600, min_speech_duration_ms=100
        )
    ...
    def process_all_tracks(self, input_mka, track_info):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=6) as executor:
            futures = [executor.submit(self.prep_audio_track, input_mka, i) for i in range(len(track_info))]
